        ...
        <div class="container">
            <div class="page-content-wrap">
                <div class="page-content">
                    <h4>Archives</h4>
                    <h2>Recommended For You<span>15 Posts</span></h2>
    ...
    <section class="archive-page padding">
        <div class="container">
                                    ...
                                    <div class="image-post-content">
                                        <ul class="post-meta">
                                            ...
                                            <li><a href="category.html"
                                                    class="date">{{ $blog->created_at->format('d.m.Y') }}</a></li>
                                        </ul>
                                        <h3><a href="{{ route('frontend.blog_detail', $blog->slug) }}"
                                                class="text-hover">{{ $blog->title }}</a></h3>
                                        <a href="{{ route('frontend.blog_detail', $blog->slug) }}" class="read-more">Continue
                                            Reading</a>
                                    </div>
                                </div>
                            </div>
            ...
            <ul class="pagination-wrap justify-content-center">
                ...
                <li><a href="#">2</a></li>
                <li><a href="#">3</a></li>
                <li><a href="#"><svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960"
